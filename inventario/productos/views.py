...
class ProductoDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['movimientos'] = MovimientoStock.objects.all()[:10]
...
class AjusteStockView(FormView):
    ...
    def get_context_data(self, **kwargs):
        complext = super().get_context_data(**kwargs)
        complext['producto'] = get_object_or_404(Producto, pk=self.kwargs['pk'])
